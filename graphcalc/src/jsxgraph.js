...
JXG.JSXGraph = {
    ...
    initBoard: function (box, attributes) {
        ...
        if (typeof attributes["boundingbox"] != 'undefined') {
            ...
            if (typeof attributes["border"] != 'undefined') {
            	    border = attributes["border"];  //left,top,right,bottom
            } else {
            	    border = [0,0,0,0];
            }
            ...
            if (attributes["keepaspectratio"]) {
                 ...
                 */
                 unitX = (w- border[0] - border[2])/(bbox[2]-bbox[0]);
                 unitY = (h- border[1] - border[3])/(-bbox[3]+bbox[1] );
                if (unitX<unitY) {
                    unitY = unitX;
                } else {
                    unitX = unitY;
            ...
            originX = -unitX*bbox[0] + border[0];
            originY = unitY*bbox[1] + border[1];
        } else {
