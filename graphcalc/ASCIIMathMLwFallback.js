...
var isIE = (navigator.appName.slice(0,9)=="Microsoft");//document.createElementNS==null;
...
{input:"h",   tag:"mi", output:"h",      tex:null, ttype:UNARY, func:true, val:true},
{input:"k",   tag:"mi", output:"k",      tex:null, ttype:UNARY, func:true, val:true},
